...
public class Mobiliario {
  ...
  public static void main(String[] args) {
    ...
    Mesa miMesa = new Mesa (Materiales.PLASTICO,5,"verde",12);
    Armario miArmario = new Armario (Materiales.PVC,100,"blanco",3);
    ...
    for (int i=0; i<10; i++) {
      conjunto[i] = new Mesa(Materiales.METAL,1+i,"amarillo"+i,13+i);
      //conjunto[i] = miMesa;
    }
    ...
    Armario objetoModificable = new Armario(Materiales.PVC,100,"blanco",3);
    Mesa objetoModificable2 = new Mesa(Materiales.CRISTAL,23,"transparente", 33);
